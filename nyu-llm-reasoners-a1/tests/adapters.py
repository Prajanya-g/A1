...
def run_scaled_dot_product_attention(
    ...
    """
    from student.model.components.attention import scaled_dot_product_attention
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from student.model.components.attention import softmax
...
def run_save_checkpoint(
    ...
    """
    from student.training.checkpointing import save_checkpoint
